...
export const HeuristLogo = ({ size = 28 }: { size?: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 28 28"
    ...
    style={{ color: 'currentcolor' }}
  >
    <rect width="28" height="28" fill="#fff" rx="5" />
    <path
      fill="#000"
      d="M14 7v7h-1.504V9.614l-1.503.872-.81.464-.694.407v5.257l.694.407.81.465V13.97h1.503v6.13l-.115-.058-1.388-.814-1.215-.697-.289-.174-1.503-.871v-7l1.503-.872.29-.174 1.214-.697 1.388-.813.115-.059L14 7.001Zm6.014 3.514v7l-1.503.872-.29.174-1.214.697-1.388.813-.115.058L14 21v-7h1.504v4.386l1.503-.872.81-.464.694-.407v-5.257l-.694-.407-.81-.465v3.515h-1.503V7.9l.115.058 1.388.814 1.215.697.289.174 1.503.871Z"
    />
  </svg>
);
